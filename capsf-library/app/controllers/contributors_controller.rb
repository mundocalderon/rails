class ContributorsController < ApplicationController
  ...
  def create
    ...
    @editor = Editor.new(params[:contributor])
    respond_to do |format|
      if @contributor.save  && @editor.save
  ...
  def update
    ...
    respond_to do |format|
      if @contributor.update_attributes(params[:contributor]) && @editor.update_attributes(params[:contributor])
