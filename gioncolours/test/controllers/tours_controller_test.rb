...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { date_begin: @tour.date_begin, date_end: @tour.date_end, description: @tour.description, title: @tour.title }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { date_begin: @tour.date_begin, date_end: @tour.date_end, description: @tour.description, title: @tour.title }
    assert_redirected_to tour_path(assigns(:tour))
  end
