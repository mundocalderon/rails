...
class GigsControllerTest < ActionController::TestCase
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post :create, gig: { date: @gig.date, details: @gig.details, link: @gig.link, location: @gig.location, venue: @gig.venue }
    end
  ...
  test "should update gig" do
    patch :update, id: @gig, gig: { date: @gig.date, details: @gig.details, link: @gig.link, location: @gig.location, venue: @gig.venue }
    assert_redirected_to gig_path(assigns(:gig))
  end
